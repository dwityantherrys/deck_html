...
{
    private $route = 'master/city/city';
    private $routeView = 'master.city.city';
    private $params = [];
    ...
    public function search(Request $request)
    {
      ...
      if($request->province) {
        $where .= " and province_id = {$request->province}";
      }
    ...
    {
      $this->params['cities'] = $this->model->with('province')->get();
    ...
    {
        $this->params['provinces'] = Province::all();
