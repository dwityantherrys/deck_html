...
{
    private $route = 'master/customer/company';
    private $routeView = 'master.company';
    private $params = [];
    ...
    {
      $this->params['companies'] = $this->model->get();
    ...
    private function _validate ($request)
    {
        ...
        return Validator::make($request, [
            'name' => ['required'],
            'phone' => ['required', 'unique:companies,phone' . $ignoredId, 'digits_between:7,12'],
            'npwp' => ['required', 'unique:companies,npwp' . $ignoredId, 'digits:15'],
