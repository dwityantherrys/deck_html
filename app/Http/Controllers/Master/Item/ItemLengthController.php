...
class ItemLengthController extends Controller
{
    private $route = 'master/item/length';
    private $routeView = 'master.item.length';
    private $params = [];

    public function __construct ()
    {
      $this->model = new ItemLength();
    ...
    {
      $this->params['lengths'] = $this->model->get();
