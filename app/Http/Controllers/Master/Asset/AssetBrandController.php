...
namespace App\Http\Controllers\Master\Asset;

use Illuminate\Http\Request;
use App\Http\Controllers\Controller;
use Illuminate\Support\Facades\Validator;

use App\Models\Master\Asset\AssetBrand;

class AssetBrandController extends Controller
{
    private $route = 'master/asset/brand';
    private $routeView = 'master.asset.brand';
    private $params = [];

    public function __construct ()
    {
      $this->model = new AssetBrand();
    ...
    {
      $this->params['brands'] = $this->model->get();
