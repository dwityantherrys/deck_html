...
<?php $loanDetails = !empty(old('loan_details')) ? old('loan_details') : $model->loan_details ?>
...
<div class="row">
  ...
  <div class="col-md-6">
    ...
    <div class="form-group @if($errors->has('loan_number')) has-error @endif">
      ...
      <input type="text" class="form-control" name="loan_number" placeholder="loan number" value="{{ !empty(old('loan_number')) ? old('loan_number') : $model->loan_number }}" readonly>
  ...
  <div class="col-md-6">
    ...
    <div class="form-group @if($errors->has('loan_expiration_date')) has-error @endif">
      ...
      <div class="input-group date">
        ...
        <input
          ...
          value="{{ empty($model->loan_expiration_date) ? date('m/d/Y') : $model->loan_expiration_date->format('m/d/Y') }}">
      </div>
      @if($errors->has('loan_expiration_date'))
        <span class="help-block">{{ $errors->first('loan_expiration_date') }}</span>
      @endif
    </div>
  ...
  <table id="vue-dynamic-element" class="table table-bordered table-hover">
    ...
    <tbody>
      <tr v-for="(element, i) in elements" :key="element.id">
        ...
        <td>
          <input type="text" class="form-control" :name="`loan_details[${i}][quantity]`" v-model="element.quantity" @change="isNumber(i, 'quantity')" placeholder="quantity">
        </td>
        <td>
