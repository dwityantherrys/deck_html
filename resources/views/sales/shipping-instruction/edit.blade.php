...
@section('title', 'Edit Shipping Instruction')

@section('content_header')
<h1>Edit Shipping Instruction:  {{ $model->quotation_number }}</h1>
@stop

@section('content')
<?php $printInformation = !empty($model->quotation_log_print) ? 'di print oleh ' . $model->quotation_log_print->employee->name . ' pada tanggal ' . $model->quotation_log_print->date->format('m/d/Y')  : ''; ?>
