  ...
  <div class="col-md-6">
    <div class="form-group @if($errors->has('order_date')) has-error @endif">
      ...
      <div class="input-group date">
        ...
        name="order_date"
        value="{{ empty($model->order_date) ? date('m/d/Y') : $model->order_date_formated }}"
        readonly>
      </div>
...
<div class="form-group @if($errors->has('shipping_status')) has-error @endif">
  ...
  <div class="form-group @if($errors->has('total_ongkir')) has-error @endif">
      ...
      <input type="text" class="form-control" name="total_ongkir" placeholder="Total Ongkir" value="{{ !empty(old('total_ongkir')) ? old('total_ongkir') : $model->total_ongkir }}">
...
{{-- @isset($coa)
  <div class="form-group row">
    ...
    <div class="col-md-12 row" id="biaya_wrapper">
      <div class="form-group col-md-12 row">
        <div class="col-md-6">
          <select class="form-control select2" name="akun_biaya[]" data-placeholder="Pilih Biaya Pembelian" style="width: 100%">
            <option value=""></option>
  ...
  <div class="form-group row">
    ...
    <div class="col-md-12">
      <select class="form-control select2" name="sumber_biaya" data-placeholder="Pilih sumber pembayaran biaya" style="width: 100%">
        <option value=""></option>
