...
<div class="box box-danger">
  <div class="box-header with-border">
      <a href="{{ url($route . '/create') }}" ><button type="button" class="btn btn-primary"><i class="fa fa-plus"></i> New Purchase Request</button></a>
...
@component("components.search", ["form" => [
  ...
  "filter_purchase_no" => ["input", "text", "form-control", "Purchase Request No", "PRXXXXX"],
  ...
  @slot("form_action")
    {{ route("request.show", round(microtime(true) * 1000)) }}
  @endslot
...
@component('components.modal')
  @slot('title') Edit Purchase Request @endslot
